...
class TripActivity : AppCompatActivity(), OnMapReadyCallback, Listener, DirectionUtil.DirectionCallBack {
    ...
    private var distanceTime = "Llegaras en 10:25 - Distancia: 10km"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bottomSheet = BottomSheetOntrip.newInstance(extraOriginName, extraDestinationName, extraOriginLat, extraOriginLng, extraDestinationLat, extraDestinationLng,distanceTime);
    ...
    private fun addOriginMarker(){
        markerOrigin =googleMap?.addMarker(MarkerOptions().position(originLatLng!!).title("Mi Posicion").icon(BitmapDescriptorFactory.fromResource(R.drawable.icons_location_person)))
    }

    private fun addDestinationMarker(){
        markerDestination =googleMap?.addMarker(MarkerOptions().position(destinationLatLng!!).title("Destino").icon(BitmapDescriptorFactory.fromResource(R.drawable.icons_pin)))
    }
    ...
    override fun pathFindFinish(
        ...
        distanceTime = "Llegaras en ${timeString}min - Distancia: ${distance}km"
