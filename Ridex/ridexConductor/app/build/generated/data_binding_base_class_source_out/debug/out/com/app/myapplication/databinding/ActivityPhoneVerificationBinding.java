...
public final class ActivityPhoneVerificationBinding implements ViewBinding {
  ...
  @NonNull
  public final Button BtnPhoneVerification;
  ...
  private ActivityPhoneVerificationBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button BtnPhoneVerification, @NonNull Button btnBack,
      @NonNull LinearLayout linearLayout2, @NonNull LinearLayout linearLayout3) {
    this.rootView = rootView;
    this.BtnPhoneVerification = BtnPhoneVerification;
  ...
  public static ActivityPhoneVerificationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.BtnPhoneVerification;
      Button BtnPhoneVerification = ViewBindings.findChildViewById(rootView, id);
      if (BtnPhoneVerification == null) {
        break missingId;
      }
      ...
      return new ActivityPhoneVerificationBinding((ConstraintLayout) rootView, BtnPhoneVerification,
          btnBack, linearLayout2, linearLayout3);
    }
